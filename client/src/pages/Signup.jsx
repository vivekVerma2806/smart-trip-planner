...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    try {
      const res = await axios.post("https://smart-trip-planner-8rdv.onrender.com/auth/register", { name, email, password });
      ...
      <div className="max-w-md w-full animate-fade-in">
        <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl shadow-blue-500/10 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 font-medium">Join thousands of smart travelers</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <span className="relative z-10">{loading ? "Creating..." : "Start Free"}</span>
